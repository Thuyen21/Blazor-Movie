...
namespace Enity.Migrations
{
    public partial class a : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AccountManagementModelMovieModel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountManagementModelMovieModel", x => new { x.MoviesId, x.StudioId });
                    table.ForeignKey(
                        name: "FK_AccountManagementModelMovieModel_AccountManagementModels_StudioId",
                        column: x => x.StudioId,
                        principalTable: "AccountManagementModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountManagementModelMovieModel_Movies_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountManagementModelMovieModel_StudioId",
                table: "AccountManagementModelMovieModel",
                column: "StudioId");
