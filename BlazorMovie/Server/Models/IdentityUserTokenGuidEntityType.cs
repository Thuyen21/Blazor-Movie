    ...
    internal partial class IdentityUserTokenGuidEntityType
    {
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var tokens = principalEntityType.AddNavigation("Tokens",
                runtimeForeignKey,
                onDependent: false,
                typeof(ICollection<IdentityUserToken<Guid>>),
                propertyInfo: typeof(ApplicationUser).GetProperty("Tokens", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(ApplicationUser).GetField("<Tokens>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
