...
public partial class Profile
{
    ...
    {
        HttpResponseMessage? response = await _httpClient.PostAsJsonAsync<ChangeEmailModel>("User/ChangeEmail", changeEmail);
        ...
        showAlert = true;
        HttpResponseMessage? r = await _httpClient.PostAsJsonAsync<ChangeEmailModel>("User/ChangeEmail", changeEmail);
